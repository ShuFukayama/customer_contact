...
# 強化ツール関連
ENHANCED_TOOLS_ON = "ON"
ENHANCED_TOOLS_OFF = "OFF"
...
# 2025/04/04 更新: Slack通知プロンプトに「メンション先の選定理由」セクションを追加
# 変更内容: メッセージの生成条件に選定理由の説明を追加し、メッセージフォーマットに新しいセクションを追加
# 変更者: AIエージェント（Roocode）
